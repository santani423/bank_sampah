        ...
        <div class="auth-right__inner mx-auto w-100">
            ...
            <form id="registerForm">
                ...
                <div class="mb-24">
                    ...
                    <input type="tel" id="no_hp" name="no_hp" class="form-control" placeholder="Contoh: 628123456789" pattern="62[0-9]*" title="No HP harus diawali dengan 62 dan hanya berisi angka">
