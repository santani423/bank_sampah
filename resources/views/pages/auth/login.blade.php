                ...
                <form method="POST" action="{{ route('login.post') }}">
                    ...
                    <div class="mb-24">
                        ...
                        <div class="position-relative">
                            <input type="text" class="form-control py-11 ps-40 @error('username') is-invalid @enderror"
                                id="username" name="username" placeholder="Type your username"
                                value="{{ old('username') }}">
                    ...
                    <div class="mb-32 flex-between flex-wrap gap-8">
                        ...
                        <a href="{{ route('forgot.password.form') }}" class="text-main-600 hover-text-decoration-underline text-15 fw-medium">Forgot
                            Password?</a>
                    </div>
