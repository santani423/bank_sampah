...
@section('main')
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Form Tambah Artikel</h3>
            <h6 class="op-7 mb-2">Di halaman ini Anda dapat menambah artikel baru.</h6>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.artikel.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="judul_postingan" required>
                        </div>
                        ...
                        {{ old('isi_postingan', $tentangKami->isi_postingan ?? '') }}
                    </textarea>
                        </div>
