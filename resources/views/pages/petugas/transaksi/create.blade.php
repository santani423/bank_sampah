                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" type="text" name="nasabah"
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered" id="setoran-detail-table">
                                ...
                                <tbody id="setoran-details">
                                    <tr>
                                        <td>
                                            <select name="detail_transaksi[0][sampah_id]"
                                        ...
                                        <td>
                                            <input type="number" step="0.01" name="detail_transaksi[0][berat_kg]"
                                                class="form-control form-control-sm berat-kg" placeholder="0.00" required>
                                        </td>
                                        <td>
                                            <input type="number" name="detail_transaksi[0][harga_per_kg]"
                                                class="form-control form-control-sm harga-per-kg" placeholder="0" readonly>
                                        </td>
                                ...
                                <tfoot class="table-light">
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input type="text" id="total-transaksi"
                                                class="form-control form-control-sm fw-bold" value="Rp 0" readonly>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
