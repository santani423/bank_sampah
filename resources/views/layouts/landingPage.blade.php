...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{ asset('wostin/files/assets/vendors/bootstrap/css/bootstrap.min.css') }}"
        />
        <link rel="stylesheet" href="{{ asset('wostin/files/assets/vendors/animate/animate.min.css') }}" />
        <link
            rel="stylesheet"
            href="{{ asset('wostin/files/assets/vendors/animate/custom-animate.css') }}"
        />
        <link
            rel="stylesheet"
            href="{{ asset('wostin/files/assets/vendors/fontawesome/css/all.min.css') }}"
        />
        ...
        <link
            rel="stylesheet"
            href="{{ asset('wostin/files/assets/vendors/nouislider/nouislider.min.css') }}"
        />
        <link
            rel="stylesheet"
            href="{{ asset('wostin/files/assets/vendors/nouislider/nouislider.pips.css') }}"
        />
        <link
            rel="stylesheet"
            href="{{ asset('wostin/files/assets/vendors/odometer/odometer.min.css') }}"
        />
        ...
        <link
            rel="stylesheet"
            href="{{ asset('wostin/files/assets/vendors/tiny-slider/tiny-slider.min.css') }}"
        />
        <link rel="stylesheet" href="{{ asset('wostin/files/assets/vendors/reey-font/stylesheet.css') }}" />
        <link
            rel="stylesheet"
            href="{{ asset('wostin/files/assets/vendors/owl-carousel/owl.carousel.min.css') }}"
        />
        <link
            rel="stylesheet"
            href="{{ asset('wostin/files/assets/vendors/owl-carousel/owl.theme.default.min.css') }}"
        />
        <link
            rel="stylesheet"
            href="{{ asset('wostin/files/assets/vendors/bxslider/jquery.bxslider.css') }}"
        />
        <link
            rel="stylesheet"
        ...
        <link
            rel="stylesheet"
            href="{{ asset('wostin/files/assets/vendors/timepicker/timePicker.css') }}"
        />
            ...
            <header class="main-header clearfix">
                <div class="main-header__inner clearfix">
                    <div class="main-header__logo">
                        <a href="index.html"
                            ><img
                                src="{{ asset('wostin/files/assets/images/resources/logo-1.png') }}"
                                alt=""
                        /></a>
                    </div>
                    <div class="main-menu__menu-box">
                        <div class="main-menu__menu-top">
                            ...
                            <div class="main-menu__menu-top-right">
                                <ul
                                    class="list-unstyled main-menu__menu-top-address"
                                >
                                    <li>
                                        <div class="icon">
                                    ...
                                    <ul class="main-menu__list">
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="service-tabs">
                                                        <div class="container">
                                                            <div
                                                                class="service-tabs__inner tabs-box"
                                                            >
                                                                <div
                                                                    class="row"
                                                                >
                                                                    ...
                                                                    >
                                                                        <ul
                                                                            class="tab-buttons service-tabs__links"
                                                                        >
                                                                            <li
                                                                                data-tab="#service-1"
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            <div
                                                                                class="tab active-tab animated fadeInUp"
                                                                                id="service-1"
                                                                            >
                                                                                <div
                                                                                    class="service-tabs__content"
                                                                                >
                                                                                    <div
                                                                                        class="service-tabs__text"
                                                                                    >
                                                                                        <h3
                                                                                            class="service-tabs__title"
                                                                                        >
                                                                                            <a
                                                                                    ...
                                                                                    <!-- /.service-tabs__text -->
                                                                                    <div
                                                                                        class="service-tabs__image"
                                                                                    >
                                                                                        <img
                                                                                            src="{{ asset('wostin/files/assets/images/services/service-m-1-1.png') }}"
                                                                                            alt=""
                                                                                        />
                                                                                    </div>
                                                                                    <!-- /.service-tabs__image -->
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    >
                                                                                        <img
                                                                                            src="{{ asset('wostin/files/assets/images/services/service-m-1-2.png') }}"
                                                                                            alt=""
                                                                                        />
                                                                                    </div>
                                                                                    <!-- /.service-tabs__image -->
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    >
                                                                                        <img
                                                                                            src="{{ asset('wostin/files/assets/images/services/service-m-1-3.png') }}"
                                                                                            alt=""
                                                                                        />
                                                                                    </div>
                                                                                    <!-- /.service-tabs__image -->
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    >
                                                                                        <img
                                                                                            src="{{ asset('wostin/files/assets/images/services/service-m-1-4.png') }}"
                                                                                            alt=""
                                                                                        />
                                                                                    </div>
                                                                                    <!-- /.service-tabs__image -->
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    >
                                                                                        <img
                                                                                            src="{{ asset('wostin/files/assets/images/services/service-m-1-5.png') }}"
                                                                                            alt=""
                                                                                        />
                                                                                    </div>
                                                                                    <!-- /.service-tabs__image -->
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    >
                                                                                        <img
                                                                                            src="{{ asset('wostin/files/assets/images/services/service-m-1-6.png') }}"
                                                                                            alt=""
                                                                                        />
                                                                                    </div>
                                                                                    <!-- /.service-tabs__image -->
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a
                                                        href="industries-carousel.html"
                                                        >Industries Carousel</a
                                                    >
                                                </li>
                                                <li>
                                                    <a
                                                        href="industry-details.html"
                                                        >Industry Details</a
                                                    >
                                                </li>
                                            </ul>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a
                                                        href="testimonials-carousel.html"
                                                        >Testimonials
                                                        Carousel</a
                                                    >
                                                </li>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="news-sidebar.html"
                                                        >News Sidebar Right</a
                                                    >
                                                </li>
                                                <li>
                                                    <a
                                                        href="news-sidebar-left.html"
                                                        >News Sidebar Left</a
                                                    >
                                                </li>
                                                <li>
    ...
    @yield('content')
            ...
            <footer class="site-footer">
                ...
                <div class="site-footer__middle">
                    <div class="container">
                        <div class="row">
                            ...
                            >
                                <div
                                    class="footer-widget__column footer-widget__services clearfix"
                                >
                                    <h3 class="footer-widget__title">
                                        Services
                                    </h3>
                                    <ul
                                        class="footer-widget__services-list list-unstyled clearfix"
                                    >
                                        <li>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div class="footer-widget__contact-info">
                                        <div
                                            class="footer-widget__contact-icon"
                                        >
                                            <span class="icon-contact"></span>
                                        </div>
                                        <div
                                            class="footer-widget__contact-content"
                                        >
                                            <p
                                                class="footer-widget__contact-mail-phone"
                                            >
                                                <a
                ...
                <div class="site-footer__bottom">
                    <div
                        class="site-footer-bottom-shape"
                        style="
